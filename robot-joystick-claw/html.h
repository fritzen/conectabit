...
<head>
    ...
    .button {
        display: block;
        margin: 10px auto; /* Adiciona um espaço entre os elementos */
        padding: 10px 20px;
    ...
    @media (orientation: landscape) {
        ...
        .button {
            margin: 10px; /* Adiciona margens para separar os botões */
        }
    }
...
<body>
    ...
    <div id='outerContainer'>
        <div id="joyDiv"></div>
        <a href="#" class="button" id="botaoAbrirFechar">Abrir/Fechar Garra</a>
    </div>
