...
#define PID_SAMPLE_TIME_IN_MILLI 6  //This is PID sample time in milliseconds
...
#define SETPOINT_PITCH_ANGLE_OFFSET -3.5

#define MIN_ABSOLUTE_SPEED 60  //Min motor speed 
...
#define PID_PITCH_KP 15  //10
#define PID_PITCH_KD 0.3
#define PID_PITCH_KI 100  //80


#define PID_YAW_KP 0.4 //0.5
#define PID_YAW_KI 0.4 //0.5
#define PID_YAW_KD 0.01  //0
...
//OFFSETS    -6946,   -4883,    1648,      -7,     -43,       5
  mpu.setXAccelOffset(-6756); 
  mpu.setYAccelOffset(-4809); 
...
void rotateMotor(int speed1, int speed2)
{
  ...
  bool reverse1 = speed1 >= 0;
  bool reverse2 = speed2 >= 0;
  // if (speed1 < 0)
  // {
  ...
  runMotor(A_IA, A_IB, reverse1, speed1);
  runMotor(B_IA, B_IB, reverse2, speed2);
