...
<div style="margin-top:10px;">&nbsp;SORRISO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SEGUIR LINHA<br></div>
&nbsp;
<label class="switch">
  <input type="checkbox" style="margin-top:40px;" onclick="Send('cmd1_' + this.checked )">
  <span class="slider round"></span>
</label>
&nbsp;&nbsp;
<label class="switch">
  <input type="checkbox" style="margin-top:40px;" onclick="Send('cmd2_' + this.checked )">
  <span class="slider round"></span>
</label>
